        ...
        <form onSubmit={handleAddCategory} className="form-group">
          ...
          <div className="mb-3">
            <input
              type="text"
              className="form-control"
              placeholder="Subcategories (comma-separated, e.g.: Semester 1, Semester 2)"
              value={subcategory}
              onChange={(e) => setSubcategory(e.target.value)}
              required
            />
            <small className="form-text text-muted">
              Enter multiple subcategories separated by commas (e.g., Semester
      ...
      <div className="mt-4">
        ...
        <form onSubmit={handleUploadNote} className="form-group">
          ...
          <div className="mb-3">
            ...
            >
              <option value="">Select Subcategory</option>
              {getSubcategoriesForCategory(category).map((subcat, idx) => (
